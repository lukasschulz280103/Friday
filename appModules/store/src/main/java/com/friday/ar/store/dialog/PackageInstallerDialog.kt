...
import com.friday.ar.store.databinding.PackageInstallerDialogBinding
...
class PackageInstallerDialog : BottomSheetDialogFragment() {
    ...
    private val viewModel by viewModel<PackageInstallerDialogViewModel>()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        require(arguments!!.getString("filePath", "").isEmpty()) { "Cannot open file dialog without a passed file argument." }
        chosenFile = File(arguments!!.getString("filePath")!!)
        viewModel.init(chosenFile)
